...
namespace SEDC.Oop.Class04.Dates
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DateTime addYear = currentDateAndTime.AddHours(3);
            ...
            string dateFormat2 = currentDateAndTime.ToString("dddd, dd MMMMM yyyy");
            string dateFormat3 = string.Format("Today is {0:MM/dd/yyyy}, {0:dddd}", currentDateAndTime);
            string dateFormat4 = string.Format("Today is {0:");
